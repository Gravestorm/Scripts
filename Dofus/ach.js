...
const ach = JSON.parse(fs.readFileSync('./PyDofus/Data/Achievements.json'))
const achr = JSON.parse(fs.readFileSync('./PyDofus/Data/AchievementRewards.json'))
const achb = JSON.parse(fs.readFileSync('./PyDofus/Data/AchievementObjectives.json'))
const achp = JSON.parse(fs.readFileSync('./PyDofus/Data/AchievementProgressSteps.json'))
const achc = JSON.parse(fs.readFileSync('./PyDofus/Data/AchievementCategories.json'))
const obj = {
  ach: [],
}
const bjo = {
