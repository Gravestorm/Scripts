const fs = require('fs')
const en = JSON.parse(fs.readFileSync('./PyDofus/i18n_en.json'))
const fspell = JSON.parse(fs.readFileSync('./PyDofus/Data/ForgettableSpells.json'))
const spell = JSON.parse(fs.readFileSync('./PyDofus/Data/Spells.json'))
const lspell = JSON.parse(fs.readFileSync('./PyDofus/Data/SpellLevels.json'))
const eff = JSON.parse(fs.readFileSync('./PyDofus/Data/Effects.json'))
const mon = JSON.parse(fs.readFileSync('./PyDofus/Data/Monsters.json'))
const rec = JSON.parse(fs.readFileSync('./PyDofus/Data/Recipes.json')) // Replace NaN to "NaN"
